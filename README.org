...
* Why not
There are several excellent QTAIM packages available for production
work. Ease of use, customization, and adjacency to featureful
technical computing platform that has a wide spectrum of methods.
